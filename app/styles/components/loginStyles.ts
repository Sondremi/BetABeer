...
export const loginScreenTokens = {
  ...
  googleButtonBackground: 'rgba(255, 255, 255, 0.94)',
  googleButtonBorder: 'rgba(15, 19, 26, 0.18)',
  googleButtonText: '#1F2937',
  googleIconColor: '#EA4335',
  dividerLine: 'rgba(255, 255, 255, 0.16)',
  dividerText: theme.colors.textSecondary,
...
export const loginStyles: any = StyleSheet.create({
  ...
  googleButton: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: loginScreenTokens.googleButtonBackground,
    borderWidth: 1,
    borderColor: loginScreenTokens.googleButtonBorder,
    shadowColor: theme.colors.shadow,
  ...
  googleButtonText: {
    color: loginScreenTokens.googleButtonText,
  ...
  authDividerLine: {
    flex: 1,
    height: 1,
    backgroundColor: loginScreenTokens.dividerLine,
  },
  authDividerText: {
    marginHorizontal: theme.spacing.md,
    color: loginScreenTokens.dividerText,
